...
angular.module('ds.products')
     ...
     */
    .controller('ProductDetailCtrl', ['$scope', '$rootScope', '$location',
        'TipsSvc', // ADJUSTED_AS_NEEDED : the products detail view will be using our TipsSvc; so introduce it as a dependency
        'CartSvc', 'product', 'lastCatId', 'variantId', 'GlobalData', 'CategorySvc','$filter', '$uibModal', 'shippingZones', 'Notification', 'ProductExtensionHelper', 'ProductVariantsHelper', 'variants', 'variantPrices', 'productFactory', 'FeeSvc',
