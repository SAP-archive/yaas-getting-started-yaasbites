...
angular.module('ds.products')
    ...
    .controller('ProductDetailCtrl', ['$scope', '$rootScope', 
        'CartSvc', 'product', 'lastCatId', 'settings', 'GlobalData', 'CategorySvc','$filter', 'ProductAttributeSvc', '$modal', 'shippingZones', 'Notification', 'CommittedMediaFilter',
        function($scope, $rootScope, 
            ...
            $scope.getRandomTip = function () { 
                var topTips = [
                "Oh My GOD, like totally, Yes!!",
                "One word: No" ,
                "Admittedly, it would make you cooler",
                "For your Granny perhaps?"];
                var i = Math.floor(Math.random() * topTips.length);
                $scope.randomTip = topTips[i];
            };
}]);
